		...
		def calcular_horas_disponiveis():
			...
			try:
				...
				if operacao_val:
					...
					total_horasextras = result_horasextras[0]["total_horas"] if result_horasextras and \
																				result_horasextras[0][
																					"total_horas"] else 0
				else:
					total_horasextras = 0
				...
				if operacao_val:
					...
					total_extras = result_extras[0]["total_horas"] if result_extras and result_extras[0][
						"total_horas"] else 0
				else:
					total_extras = 0
